...
class StatisticsModel():
    ...
    def update(self):
        ...
        self.widget.setItem(0, 1, QtWidgets.QTableWidgetItem(str(self.num_images)))
        self.widget.setItem(1, 0, QtWidgets.QTableWidgetItem(StatisticsModel.STATISTICS_SUB_ITEM_PREFIX + _('Labeled')))
        self.widget.setItem(1, 1, QtWidgets.QTableWidgetItem(str(self.image_types['labeled'])))
        self.widget.setItem(2, 0, QtWidgets.QTableWidgetItem(StatisticsModel.STATISTICS_SUB_ITEM_PREFIX + _('Unlabeled')))
        self.widget.setItem(2, 1, QtWidgets.QTableWidgetItem(str(self.image_types['unlabeled'])))
        self.widget.setItem(3, 0, QtWidgets.QTableWidgetItem(_('Labels')))
        self.widget.setItem(3, 1, QtWidgets.QTableWidgetItem(str(self.num_labels)))
        self.widget.setItem(4, 0, QtWidgets.QTableWidgetItem(_('Annotations')))
        self.widget.setItem(4, 1, QtWidgets.QTableWidgetItem(str(self.num_shapes)))
        ...
        for i, label_name in enumerate(self.label_count.keys()):
            ...
            self.widget.setItem(row, 1, QtWidgets.QTableWidgetItem(str(label_count)))
